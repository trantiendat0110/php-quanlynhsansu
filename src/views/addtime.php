        ...
        <section class="float-right w-5/6 relative admin_content">
            ...
            <!-- <div class="content-home bg_user">
                <div class="flex justify-between text-green-900 font-medium">
                    <p class="border border-slate-400 rounded border-0 border-r-4 border-b-4 m-4 p-2">Tăng ca</p>
                </div>
                    ...
                    <table class="min-w-full leading-normal">
                        <thead>
                            <tr>
                                ...
                                <th class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    Số buổi tăng ca (T <?php echo date('m') ?>)
                                </th>
                                <th class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    *
                                </th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 text-center ">
                                        <p class=" bg-green-200 text-green-600 inline p-2 px-4 rounded-full whitespace-no-wrap">
                                            <?php
            ...
            <p class="block text-center font-medium text-2xl mt-40">Đang phát triển </p>
        </section>
