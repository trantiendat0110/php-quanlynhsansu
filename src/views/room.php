...
<body>
    <main>
        ...
        <section class="float-right w-5/6 admin_content">
            ...
            ?>
            <p class="error"><?php if (!empty($_SESSION['error'])) {
                echo $_SESSION['error'];
            }?></p>
            <div class="content m-4">
                <h3 class="p-2 bg-slate-100 rounded">QUẢN LÝ PHÒNG BAN</h3>
                <div class="flex justify-around p-4">
                    <div class="text-center border border-0 w-full border-r-2 border-red-slate-300">
                        <h1 class="font-medium m-4">Danh sách phòng ban</h1>
                                ...
                                ?>
                                    <tr>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap"><?php echo $rows['maPB'] ?></p>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <form class="" action="./crud.php" method="get">
                                                <input type="text" class="hidden" name="delete-room" value="delete-room">
                                                <input name="maPB" value="<?php echo $rows['maPB'] ?>" class="hidden" type="text">
                    ...
                    <div class="text-center w-full ">
                        <h1 class="font-medium m-4">Thêm phòng ban</h1>
                        <hr class="w-1/2 m-auto">
                        <form class="mt-10" action="./crud.php" method="get">
                            <label for="">Mã phòng ban</label>
                            <input type="text" class="hidden" name="add-room" value="add-room">
                            <input name="maPB" class="block bg-slate-200 shadow rounded p-2 m-auto mb-10 mt-2" type="text">
                            <label for="">Tên phòng ban</label>
                            <input name="tenPB" class="block bg-slate-200 shadow rounded p-2 m-auto mb-10 mt-2" type="text">
